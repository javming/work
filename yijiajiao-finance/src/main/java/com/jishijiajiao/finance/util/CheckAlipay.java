...
public class CheckAlipay{
	...
	// 请求验证的地址 
	private static final String ACCTSTATUSCHECK_URL ="https://auth.alipay.com/login/verifyId.json";// "https://memberprod.alipay.com/account/reg/acctStatusCheck.json";
...
//		String acctType = "email"; //可以为空
	...
	public static void main(String[] args) {
		System.err.println(CheckAlipay.checkAlipay("123"));
	}
}
